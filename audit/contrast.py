...
PAIRS = [
    ...
    ("light brand / bg",    "#08525b", "#ffffff"),
    ("light brand / surf",  "#08525b", "#eef2f6"),
    ("light btn text",      "#ffffff", "#084a53"),
    ("dark body text",      "#e8eef4", "#0d1117"),
    ("dark muted / bg",     "#aeb9c5", "#0d1117"),
    ("dark muted / surf",   "#aeb9c5", "#161c26"),
    ("dark brand / bg",     "#4fd6c9", "#0d1117"),
    ("dark brand / surf",   "#4fd6c9", "#161c26"),
    ("dark btn text",       "#0d1117", "#4fd6c9"),
]
