---
title: Pacs008 | العربية
description: توليد والتحقق وواجهات برمجة التطبيقات والامتثال لتدفقات التحويل بين المؤسسات المالية.
lang: ar-SA
lastUpdated: true
image: /logo.svg
---

# أتمتة رسائل pacs.008 بثقة.

توليد والتحقق وواجهات برمجة التطبيقات والامتثال لتدفقات التحويل بين المؤسسات المالية.
