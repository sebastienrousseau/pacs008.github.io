...
<div class="message-comparison-table" tabindex="0" aria-label="مقارنة pacs.008 vs pacs.009">
  <table>
    <caption>مقارنة pacs.008 vs pacs.009</caption>
    <colgroup>
...
<div class="message-versions-table" tabindex="0" aria-label="الإصدارات المدعومة">
  <table>
    <colgroup>
    ...
    <tbody>
        ...
        <tr>
          ...
          <td class="message-versions-table__status"><strong>الحالي</strong></td>
        </tr>
    </tbody>
  </table>
</div>
