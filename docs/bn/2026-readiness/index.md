---
title: "২০২৬-এর জন্য ISO 20022 প্রস্তুতি | pacs008"
...
# ২০২৬-এর জন্য ISO 20022 প্রস্তুতি

**১৪ নভেম্বর ২০২৬** পর্যন্ত **100 দিন**, 2026-08-06 অনুযায়ী।

ওই তারিখ থেকে সম্পূর্ণ অসংগঠিত ডাক ঠিকানা SWIFT CBPR+ পেমেন্ট বার্তায় এবং ব্যাংক অব ইংল্যান্ডের CHAPS যাচাই লাইব্রেরিতে আর গ্রহণ করা হবে না। একই দিনে আরও দুটি পরিবর্তন কার্যকর হয়, এবং নভেম্বর ২০২৭-এ বৃহত্তর একটি সেট আসে।

নিচের প্রতিটি নিয়মে একটি শনাক্তকারী, কার্যকর তারিখ, নির্ভরযোগ্য সূত্র ও পরীক্ষার ফাইল আছে — এখানে কিছুই বিশ্বাসের ওপর নিতে হয় না।

## এটি কি আপনার ক্ষেত্রে প্রযোজ্য?

যদি আপনি কোনো পক্ষের ডাক ঠিকানাসহ CBPR+ বা CHAPS পেমেন্ট পাঠান, তবে এটি আপনার ক্ষেত্রে প্রযোজ্য।

| | |
|---|---|
| **বার্তা** | `pacs.008`, `pacs.009`, `pacs.004`, `pacs.003` |
| **পক্ষ** | Debtor, creditor, ultimate debtor, ultimate creditor, and agents that carry an address |
| **পরিধির বাইরে** | `admi.024`, `camt.025`, `camt.052`, `camt.053`, `camt.054`, `camt.060` |
| **অব্যাহতিপ্রাপ্ত** | Agents identified by BIC alone need no postal address (`CBPR-ADDR-005`) |

## আসলে কী পরিবর্তন হচ্ছে

শর্তটি **ন্যূনতম, সর্বোচ্চ নয়**। এই অংশটিই সবচেয়ে বেশি ভুল বোঝা হয়।

| ফরম্যাট | `TwnNm` | `Ctry` | `AdrLine` | ১৪ নভে ২০২৬-এর আগে | ওই তারিখ থেকে |
|---|---|---|---|---|---|
| সম্পূর্ণ সংগঠিত | আছে | আছে | নেই | গৃহীত | গৃহীত |
| হাইব্রিড | আছে | আছে | আছে | গৃহীত | **গৃহীত** |
| সম্পূর্ণ অসংগঠিত | নেই | নেই | আছে | গৃহীত | **প্রত্যাখ্যাত** |

রাস্তা, ভবন নম্বর ও পোস্ট কোড সংগঠিত উপাদানে সরানোর **প্রয়োজন নেই**। `<TwnNm>`-এ শহর এবং `<Ctry>`-তে দুই-অক্ষরের ISO 3166 কোড হিসেবে দেশ যথেষ্ট। বাকিটা ঠিকানার লাইনে থাকতে পারে: এটি একটি হাইব্রিড ঠিকানা এবং বৈধ থাকে।

[Full detail, with worked examples →](/structured-address/)

## এখনই আপনার ডেটা যাচাই করুন

দুটি সরঞ্জাম, উভয়ই সম্পূর্ণরূপে আপনার ব্রাউজারে চলে। কোনো পেমেন্ট ডেটা পাঠানো হয় না।
...
## শুধু এটিই নয়, সব মাইলফলক

নভেম্বর ২০২৬ ISO 20022 পরিবর্তনের শেষ নয়। ওই তারিখ থেকে Swift বার্ষিক Standards Release চক্রে যায়, তাই ব্যবহারের নির্দেশিকা প্রতি বছর বদলাবে।
...
## ভূমিকা অনুযায়ী কী যাচাই করবেন
