---
title: "מוכנות ל-ISO 20022 לשנת 2026 | pacs008"
...
# מוכנות ל-ISO 20022 לשנת 2026

**100 ימים** ל-**14 בנובמבר 2026**, נכון ל-2026-08-06.
...
זה נוגע לך אם אתה שולח תשלומי CBPR+ או CHAPS הכוללים כתובת דואר עבור צד כלשהו.

| | |
|---|---|
| **הודעות** | `pacs.008`, `pacs.009`, `pacs.004`, `pacs.003` |
| **צדדים** | Debtor, creditor, ultimate debtor, ultimate creditor, and agents that carry an address |
| **מחוץ לתחולה** | `admi.024`, `camt.025`, `camt.052`, `camt.053`, `camt.054`, `camt.060` |
| **פטור** | Agents identified by BIC alone need no postal address (`CBPR-ADDR-005`) |
...
## בדוק את הנתונים שלך עכשיו

שני כלים הפועלים כולם בדפדפן שלך. שום נתוני תשלום אינם נשלחים.
...
## כל אבני הדרך, לא רק זו

נובמבר 2026 אינו סוף השינויים ב-ISO 20022. ממועד זה עוברת Swift למחזור שנתי של Standards Release, ולכן הנחיות השימוש ישתנו מדי שנה.
