...
image: /logo.svg
faq:
  - question: "האם pacs.007 מיועד רק לתרחישי הונאה?"
    answer: "לא. הונאה היא מקרה שימוש עיקרי, אך כל צורך מצד המורה לבטל תשלום יכול להפעיל אותו."
  - question: "האם ניתן לטפל בו כמו החזרה רגילה?"
    answer: "לא. תזמון הביטול, לכידת הסיבה והתאמה שונים מהותית מהחזרות."
---
