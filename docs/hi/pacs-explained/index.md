...
## MT103 से pacs.008 फ़ील्ड मैपिंग

<div class="api-fields-table" tabindex="0" aria-label="MT103 से pacs.008 फ़ील्ड मैपिंग">
  <table>
    <caption>MT103 से pacs.008 की प्रमुख फ़ील्ड मैपिंग</caption>
    <colgroup>
      <col class="api-fields-table__col-field">
      <col class="api-fields-table__col-desc">
      <col class="api-fields-table__col-constraint">
    ...
    <thead>
      <tr>
        <th scope="col">MT103 फ़ील्ड</th>
        <th scope="col">MT103 नाम</th>
        <th scope="col">pacs.008 XML पथ</th>
      </tr>
    </thead>
    <tbody>
        <tr><td class="api-fields-table__field">20</td><td class="api-fields-table__desc">प्रेषक का संदर्भ</td><td class="api-fields-table__constraint">GrpHdr/MsgId or PmtId/InstrId</td></tr>
        <tr><td class="api-fields-table__field">23B</td><td class="api-fields-table__desc">बैंक संचालन कोड</td><td class="api-fields-table__constraint">PmtTpInf/SvcLvl</td></tr>
        <tr><td class="api-fields-table__field">32A</td><td class="api-fields-table__desc">मूल्य तिथि / राशि</td><td class="api-fields-table__constraint">IntrBkSttlmDt + IntrBkSttlmAmt</td></tr>
        <tr><td class="api-fields-table__field">33B</td><td class="api-fields-table__desc">निर्देशित राशि</td><td class="api-fields-table__constraint">InstdAmt</td></tr>
        <tr><td class="api-fields-table__field">50a</td><td class="api-fields-table__desc">आदेश देने वाला ग्राहक</td><td class="api-fields-table__constraint">Dbtr + DbtrAcct</td></tr>
        <tr><td class="api-fields-table__field">52a</td><td class="api-fields-table__desc">आदेश देने वाली संस्था</td><td class="api-fields-table__constraint">DbtrAgt</td></tr>
        <tr><td class="api-fields-table__field">57a</td><td class="api-fields-table__desc">खाता संस्था</td><td class="api-fields-table__constraint">CdtrAgt</td></tr>
        <tr><td class="api-fields-table__field">59a</td><td class="api-fields-table__desc">लाभार्थी ग्राहक</td><td class="api-fields-table__constraint">Cdtr + CdtrAcct</td></tr>
        <tr><td class="api-fields-table__field">70</td><td class="api-fields-table__desc">प्रेषण जानकारी</td><td class="api-fields-table__constraint">RmtInf/Ustrd or RmtInf/Strd</td></tr>
        <tr><td class="api-fields-table__field">71A</td><td class="api-fields-table__desc">शुल्क विवरण</td><td class="api-fields-table__constraint">ChrgBr (BEN→CRED, OUR→DEBT, SHA→SHAR)</td></tr>
        <tr><td class="api-fields-table__field">72</td><td class="api-fields-table__desc">प्रेषक से प्राप्तकर्ता सूचना</td><td class="api-fields-table__constraint">InstrForCdtrAgt / InstrForNxtAgt</td></tr>
...
<div class="api-fields-table" tabindex="0" aria-label="pacs.002 स्थिति कोड">
  <table>
    ...
    <thead>
      <tr>
        <th scope="col">कोड</th>
        <th scope="col">अर्थ</th>
      </tr>
    </thead>
    <tbody>
        <tr><td class="api-fields-table__field"><code>ACCP</code></td><td class="api-fields-table__desc">स्वीकृत — प्रारंभिक जाँचें उत्तीर्ण</td></tr>
...
### सामान्य अस्वीकृति और वापसी कारण कोड

<div class="api-fields-table" tabindex="0" aria-label="सामान्य कारण कोड">
  <table>
    <caption>अक्सर उपयोग किए जाने वाले अस्वीकृति और वापसी कारण कोड</caption>
    <colgroup>
      <col class="api-fields-table__col-field">
      <col class="api-fields-table__col-desc">
      <col class="api-fields-table__col-constraint">
    ...
    <tbody>
        <tr><td class="api-fields-table__field"><code>AC01</code></td><td class="api-fields-table__desc">गलत खाता संख्या</td><td class="api-fields-table__constraint">खाता संख्या अमान्य है या मौजूद नहीं है</td></tr>
        <tr><td class="api-fields-table__field"><code>AC04</code></td><td class="api-fields-table__desc">बंद खाता</td><td class="api-fields-table__constraint">खाता बंद है</td></tr>
        <tr><td class="api-fields-table__field"><code>AC06</code></td><td class="api-fields-table__desc">अवरुद्ध खाता</td><td class="api-fields-table__constraint">खाता लेनदेन के लिए अवरुद्ध है</td></tr>
        <tr><td class="api-fields-table__field"><code>AM04</code></td><td class="api-fields-table__desc">अपर्याप्त धनराशि</td><td class="api-fields-table__constraint">देनदार खाते में अपर्याप्त धनराशि</td></tr>
        <tr><td class="api-fields-table__field"><code>AM05</code></td><td class="api-fields-table__desc">दोहराव</td><td class="api-fields-table__constraint">दोहरा भुगतान पाया गया</td></tr>
        <tr><td class="api-fields-table__field"><code>BE04</code></td><td class="api-fields-table__desc">लेनदार का पता गायब</td><td class="api-fields-table__constraint">लेनदार का पता गायब या अपूर्ण है</td></tr>
        <tr><td class="api-fields-table__field"><code>CUST</code></td><td class="api-fields-table__desc">ग्राहक द्वारा अनुरोधित</td><td class="api-fields-table__constraint">ग्राहक द्वारा अनुरोधित वापसी या अस्वीकृति</td></tr>
        <tr><td class="api-fields-table__field"><code>DUPL</code></td><td class="api-fields-table__desc">दोहरा भुगतान</td><td class="api-fields-table__constraint">दोहरा भुगतान पहचाना गया</td></tr>
        <tr><td class="api-fields-table__field"><code>FOCR</code></td><td class="api-fields-table__desc">रद्दीकरण के बाद</td><td class="api-fields-table__constraint">रद्दीकरण अनुरोध के बाद</td></tr>
        <tr><td class="api-fields-table__field"><code>FR01</code></td><td class="api-fields-table__desc">धोखाधड़ी</td><td class="api-fields-table__constraint">धोखाधड़ी का संदेह</td></tr>
        <tr><td class="api-fields-table__field"><code>RC01</code></td><td class="api-fields-table__desc">गलत BIC</td><td class="api-fields-table__constraint">BIC गलत या अज्ञात है</td></tr>
        <tr><td class="api-fields-table__field"><code>RR03</code></td><td class="api-fields-table__desc">लेनदार का नाम/पता गायब</td><td class="api-fields-table__constraint">लेनदार का नाम या पता डेटा गायब है</td></tr>
        <tr><td class="api-fields-table__field"><code>TM01</code></td><td class="api-fields-table__desc">समय सीमा</td><td class="api-fields-table__constraint">प्रसंस्करण की समय सीमा बीत चुकी है</td></tr>
    </tbody>
  </table>
</div>
