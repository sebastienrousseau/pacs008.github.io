...
<div class="operational-matrix-table" tabindex="0" aria-label="प्रमुख डेटा तत्व व्यावसायिक संदर्भ">
  <table>
    ...
    <tbody>
        ...
        <tr>
          <td class="operational-matrix-table__left">**DrctDbtTxInf** — राशि और पक्षों के साथ प्रत्यक्ष डेबिट लेनदेन सूचना</td>
        ...
        <tr>
          <td class="operational-matrix-table__left">**Cdtr** — लेनदार पहचान और खाता विवरण</td>
          <td class="operational-matrix-table__right">ऋणी और लेनदार के बीच वैध अधिदेश संदर्भ की आवश्यकता होती है</td>
        </tr>
        <tr>
          <td class="operational-matrix-table__left">**CdtrAgt** — लेनदार एजेंट (संग्रह संस्थान) पहचान</td>
        ...
        <tr>
          <td class="operational-matrix-table__left">**DbtrAgt** — ऋणी एजेंट (भुगतान संस्थान) पहचान</td>
