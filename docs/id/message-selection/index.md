...
|---|---|
| `pacs.008` vs `pacs.009` | Pembayaran nasabah versus perpindahan dana institusional atau pembayaran penutup |
| `pacs.004` vs `pacs.007` | Retur dari pihak penerima versus pembalikan dari pihak pengirim |
