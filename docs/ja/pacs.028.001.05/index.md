...
<div class="operational-matrix-table" tabindex="0" aria-label="主要データ要素 ビジネスコンテキスト">
  <table>
    ...
    <tbody>
        ...
        <tr>
          <td class="operational-matrix-table__left">**TxInf** — 照会対象の支払を識別する取引情報</td>
        ...
        <tr>
          <td class="operational-matrix-table__left">**OrgnlInstrId** — 元の支払からの元指図識別子</td>
          <td class="operational-matrix-table__right">例外処理および SLA モニタリングワークフローで使用</td>
        </tr>
        <tr>
          <td class="operational-matrix-table__left">**OrgnlEndToEndId** — トレーサビリティのための元エンドツーエンド識別子</td>
