...
<div class="operational-matrix-table" tabindex="0" aria-label="핵심 데이터 요소 비즈니스 컨텍스트">
  <table>
    ...
    <tbody>
        ...
        <tr>
          <td class="operational-matrix-table__left">**TxInf** — 취소 금액 및 당사자 정보가 포함된 거래 정보</td>
        ...
        <tr>
          <td class="operational-matrix-table__left">**RvslRsnInf** — 구조화된 사유 코드가 포함된 취소 사유 정보</td>
          <td class="operational-matrix-table__right">하류 처리를 위한 구조화된 취소 사유 코드 포함</td>
        </tr>
        <tr>
          <td class="operational-matrix-table__left">**OrgnlTxRef** — 엔드투엔드 추적성을 위한 원본 거래 참조</td>
