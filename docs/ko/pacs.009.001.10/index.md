...
<div class="operational-matrix-table" tabindex="0" aria-label="핵심 데이터 요소 비즈니스 컨텍스트">
  <table>
    ...
    <tbody>
        ...
        <tr>
          <td class="operational-matrix-table__left">**CdtTrfTxInf** — 은행 간 결제 금액이 포함된 신용이체 거래 정보</td>
          <td class="operational-matrix-table__right">환거래 은행 파트너 간 유동성 관리 지원</td>
        </tr>
        <tr>
          <td class="operational-matrix-table__left">**Dbtr / DbtrAgt** — 채무자 기관 및 에이전트 식별</td>
          <td class="operational-matrix-table__right">커버 방식으로 결제되는 고객 신용이체의 커버 레그를 포함</td>
        </tr>
        <tr>
          <td class="operational-matrix-table__left">**Cdtr / CdtrAgt** — 채권자 기관 및 에이전트 식별</td>
          <td class="operational-matrix-table__right">금융기관 간 자금 운용 및 조달 업무 가능</td>
        </tr>
        <tr>
          <td class="operational-matrix-table__left">**IntrBkSttlmAmt** — 결제 통화로 표시된 은행 간 결제 금액</td>
