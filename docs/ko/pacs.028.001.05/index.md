...
<div class="operational-matrix-table" tabindex="0" aria-label="핵심 데이터 요소 비즈니스 컨텍스트">
  <table>
    ...
    <tbody>
        ...
        <tr>
          <td class="operational-matrix-table__left"><strong>TxInf</strong> — 조회 대상 결제를 식별하는 거래 정보</td>
        ...
        <tr>
          <td class="operational-matrix-table__left"><strong>OrgnlInstrId</strong> — 원본 결제의 원본 지시 식별자</td>
          <td class="operational-matrix-table__right">예외 처리 및 SLA 모니터링 워크플로에서 사용</td>
        </tr>
        <tr>
          <td class="operational-matrix-table__left"><strong>OrgnlEndToEndId</strong> — 추적성을 위한 원본 엔드투엔드 식별자</td>
...
<div class="message-comparison-table" tabindex="0" aria-label="비교 pacs.028 vs pacs.002">
  <table>
    <caption>비교 pacs.028 vs pacs.002</caption>
    <colgroup>
