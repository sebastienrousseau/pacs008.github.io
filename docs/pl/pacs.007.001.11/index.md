...
image: /logo.svg
faq:
  - question: "Czy pacs.007 jest tylko do scenariuszy oszustw?"
    answer: "Nie. Oszustwo jest głównym przypadkiem użycia, ale każda potrzeba strony zlecającej do odwrócenia płatności może go uruchomić."
  - question: "Czy można go obsłużyć jak normalny zwrot?"
    answer: "Nie. Czas odwrócenia, przechwytywanie przyczyny i uzgadnianie różnią się istotnie od zwrotów."
---
