...
description: Что делает pacs008 и для кого он предназначен. Генерация, валидация, оркестрация API и поддержка комплаенса для потоков кредитовых переводов FI-to-FI.
lang: ru-RU
lastUpdated: true
image: /logo.svg
---
