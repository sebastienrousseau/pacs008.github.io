---
title: API | pacs008
description: Поддержка рабочих процессов REST и CLI в pacs008. Генерация, валидация, оркестрация API и поддержка комплаенса для потоков кредитовых переводов FI-to-FI.
lang: ru-RU
lastUpdated: true
image: /logo.svg
---
