...
image: /logo.svg
faq:
  - question: "pacs.007 предназначен только для сценариев мошенничества?"
    answer: "Нет. Мошенничество — основной случай использования, но любая необходимость со стороны инструктора отменить платёж может его активировать."
  - question: "Можно ли обрабатывать его как обычный возврат?"
    answer: "Нет. Сроки отмены, фиксация причины и сверка существенно отличаются от возвратов."
---
...
<div class="operational-matrix-table" tabindex="0" aria-label="Ключевые элементы данных Бизнес-контекст">
  <table>
    ...
    <tbody>
        ...
        <tr>
          <td class="operational-matrix-table__left"><strong>TxInf</strong> — Информация о транзакции с суммой сторнирования и сторонами</td>
        ...
        <tr>
          <td class="operational-matrix-table__left"><strong>RvslRsnInf</strong> — Информация о причине сторнирования со структурированными кодами причин</td>
        ...
        <tr>
          <td class="operational-matrix-table__left"><strong>OrgnlTxRef</strong> — Ссылка на исходную транзакцию для сквозной отслеживаемости</td>
...
<div class="message-comparison-table" tabindex="0" aria-label="Сравнение pacs.007 vs pacs.004">
  <table>
    <caption>Сравнение pacs.007 vs pacs.004</caption>
    <colgroup>
