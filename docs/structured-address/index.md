---
title: November 2026 Structured Address Deadline — CBPR+
...
- **22 November 2025** — the hybrid postal address option becomes available, and the MT/MX coexistence period for payment instructions ends.
- **14 November 2026** — fully unstructured postal addresses are rejected in CBPR+ and by the CHAPS validation library. MT101 interbank coexistence over CBPR+ also ends, and camt.110 investigation requests must be receivable.
