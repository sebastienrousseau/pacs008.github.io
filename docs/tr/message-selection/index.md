...
|---|---|
| `pacs.008` vs `pacs.009` | Müşteri ödemesi ile kurum/cover hareketi arasındaki fark |
| `pacs.004` vs `pacs.007` | Alıcı taraftan iade ile gönderen taraftan reversal arasındaki fark |
