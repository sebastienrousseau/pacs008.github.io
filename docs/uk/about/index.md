...
description: Що робить pacs008 і для кого він призначений. Генерація, валідація, оркестрація API та підтримка комплаєнсу для потоків клієнтських кредитових переказів...
lang: uk-UA
lastUpdated: true
image: /logo.svg
---
