...
image: /logo.svg
faq:
  - question: "Яка різниця між pacs.004 і pacs.007?"
    answer: "pacs.004 повертає розраховані кошти з боку одержувача, тоді як pacs.007 запитує скасування з боку первісного інструктора."
  - question: "Чи повинен кожен невдалий кредит бенефіціара ставати pacs.004?"
    answer: "Не автоматично. Правильний шлях залежить від правил схеми, стадії розрахунку та обробки контрагента."
---
