...
image: /logo.svg
faq:
  - question: "什麼時候應該選擇 pacs.009 而不是 pacs.008？"
    answer: "自有帳戶轉帳和覆蓋腿選擇 pacs.009；客戶信用轉帳指令選擇 pacs.008。"
  - question: "為什麼 pacs.009 通常比預期更難對帳？"
    answer: "因為銀行必須保持資金管理融資、代理行腿和任何關聯客戶支付之間的關係。"
---
