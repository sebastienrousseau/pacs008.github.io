...
<div class="operational-matrix-table" tabindex="0" aria-label="关键数据要素 业务背景">
  <table>
    ...
    <tbody>
        ...
        <tr>
          <td class="operational-matrix-table__left">**DrctDbtTxInf** — 包含金额和当事方信息的直接借记交易信息</td>
          <td class="operational-matrix-table__right">用于订阅、公共事业费和贷款偿还等经常性支付收款</td>
        </tr>
        <tr>
          <td class="operational-matrix-table__left">**Cdtr** — 债权人标识和账户详细信息</td>
          <td class="operational-matrix-table__right">需要债务人和债权人之间的有效授权引用</td>
        </tr>
        <tr>
          <td class="operational-matrix-table__left">**CdtrAgt** — 债权人代理（收款机构）标识</td>
          <td class="operational-matrix-table__right">支持在单条消息中批量收取多笔直接借记指令</td>
        </tr>
        <tr>
          <td class="operational-matrix-table__left">**DbtrAgt** — 债务人代理（付款机构）标识</td>
