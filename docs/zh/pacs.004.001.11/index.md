...
image: /logo.svg
faq:
  - question: "pacs.004 和 pacs.007 有什么区别？"
    answer: "pacs.004 从接收方退回已结算资金，而 pacs.007 从原始指令方请求撤销。"
  - question: "每个失败的受益人贷记都应该变成 pacs.004 吗？"
    answer: "不是自动的。正确的路径取决于方案规则、结算阶段和对手方处理。"
---
