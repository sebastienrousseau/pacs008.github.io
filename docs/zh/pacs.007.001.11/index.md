...
image: /logo.svg
faq:
  - question: "pacs.007 仅用于欺诈场景吗？"
    answer: "不是。欺诈是主要用例，但指令方任何需要撤销支付的情况都可以触发它。"
  - question: "可以像正常退回一样处理吗？"
    answer: "不可以。撤销时间、原因记录和对账与退回有实质性差异。"
---
...
<div class="message-comparison-table" tabindex="0" aria-label="比较 pacs.007 vs pacs.004">
  <table>
    <caption>比较 pacs.007 vs pacs.004</caption>
    <colgroup>
